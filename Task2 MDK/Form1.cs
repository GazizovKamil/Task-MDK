...
namespace Task2_MDK
{
    public partial class Form1 : Form
    {
        ...
        {
            tb_SwimValue1.KeyPress += TextBox_KeyPress;
            tb_SwimValue2.KeyPress += TextBox_KeyPress;
            tb_SwimValue3.KeyPress += TextBox_KeyPress;
            tb_CycleValue1.KeyPress += TextBox_KeyPress;
            tb_CycleValue2.KeyPress += TextBox_KeyPress;
            tb_CycleValue3.KeyPress += TextBox_KeyPress;
            tb_RunValue1.KeyPress += TextBox_KeyPress;
            tb_RunValue3.KeyPress += TextBox_KeyPress;
        }

        private bool AreTextBoxesFilled()
        {
            return !string.IsNullOrEmpty(tb_SwimValue1.Text) &&
                   !string.IsNullOrEmpty(tb_SwimValue2.Text) &&
                   !string.IsNullOrEmpty(tb_SwimValue3.Text) &&
                   !string.IsNullOrEmpty(tb_CycleValue1.Text) &&
                   !string.IsNullOrEmpty(tb_CycleValue2.Text) &&
                   !string.IsNullOrEmpty(tb_CycleValue3.Text) &&
                   !string.IsNullOrEmpty(tb_RunValue1.Text) &&
                   !string.IsNullOrEmpty(tb_RunValue3.Text);
        }
    }
}
